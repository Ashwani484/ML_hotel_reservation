...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            #getting categorical and numerical columns from config file
            ...
            for col in cat_cols:
                df[col].drop(columns=['Unnamed: 0',"Booking_ID"] , inplace=True)
            ...
            #applying log1p transformation to the columns having skewness more than threshold
    ...
    def select_features(self,df):
        try:
            ...
            #top n features to select as per config file
...
'''    
#final running the data processing class    
